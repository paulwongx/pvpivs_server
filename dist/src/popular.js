...
var getPopular = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "https://www.gamepress.gg/pokemongo/popular-pokemon-all";
            ...
            case 2:
                ...
                $(".view-id-popular_pages")
                    ...
                    var _a, _b;
                    if (i < 100) {
                        var rawDex = (_b = (_a = $(el).attr("href")) === null || _a === void 0 ? void 0 : _a.match(re)) === null || _b === void 0 ? void 0 : _b[1];
                        var dex = rawDex ? parseInt(rawDex) : null;
                        var name = $(el)
                            .find(".pages-ranking-title")
                            .text()
                            .replace(/\n/g, "");
                        res.push({ dex: dex, name: name });
                    }
                });
                json = res.filter(function (x) { return x.dex !== null; });
                file = {
                    date: new Date(),
                    pokemon: json
                };
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getPopular()];
            case 1:
                res = _a.sent();
                console.log(res);
                return [2 /*return*/];
